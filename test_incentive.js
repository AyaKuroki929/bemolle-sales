...
const Y = 'スタッフ1';
// 8/15 ①お客様A 全身12回(-5%) 287,280 → 1件目 5% = 14,364 ＋全身3,000
sale('2026-08-05', 'お客様A', Y, [{t:'施術',n:'全身',k:'全身'}, {t:'契約',n:'全身12回',k:'通常契約',net:287280}]);
// 8/18 ②お客様B プラペン6回 198,000 → 2件目 5% = 9,900 ＋全身3,000
sale('2026-08-08', 'お客様B', Y, [{t:'施術',n:'全身',k:'全身'}, {t:'契約',n:'プラペン6回',k:'通常契約',net:198000}]);
// 8/17 ③お客様C 全身12回 302,400 → 3件目 8% = 24,192 ＋全身3,000
sale('2026-08-17', 'お客様C', Y, [{t:'施術',n:'全身',k:'全身'}, {t:'契約',n:'全身12回',k:'通常契約',net:302400}]);
// 8/19 ④お客様B 全身6回 151,620 → 4件目 8% = 12,129
sale('2026-08-19', 'お客様B', Y, [{t:'契約',n:'全身6回',k:'通常契約',net:151620}]);
// 8/20 ⑤お客様D 全身12回 287,280 → 5件目 10% = 28,728
sale('2026-08-20', 'お客様D', Y, [{t:'契約',n:'全身12回',k:'通常契約',net:287280}]);
// 8/24 ⑥お客様D 全身12回 302,400 → 6件目 10% = 30,240 ＋全身3,000 ＋物販105,600の10%=10,560
sale('2026-08-24', 'お客様D', Y, [
  {t:'施術',n:'全身',k:'全身'},
...
// 8/21 お客様E・お客様F 全身×2 ＋ お客様F物販7,700(8%)→770
sale('2026-08-21', 'お客様E', Y, [{t:'施術',n:'全身',k:'全身'}]);
sale('2026-08-21', 'お客様F', Y, [{t:'施術',n:'全身',k:'全身'}, {t:'物販',n:'HRプロテイン黒蜜',k:'物販',net:7700,tax:8}]);
// 上限テスト：同じ日に全身4件（上限3件）→ 3件分しか付かない
['A','B','C','D'].forEach(c => sale('2026-08-26', c+'様', Y, [{t:'施術',n:'全身',k:'全身'}]));
// ラジショット契約（件数に数えず5%固定）
sale('2026-08-27', 'お客様E', Y, [{t:'契約',n:'ラジショット6回',k:'ラジショット',net:100000}]);
// 折半：施術者とアポインターが違う場合 → 半額ずつ
sale('2026-08-28', 'お客様G', Y, [{t:'施術',n:'全身',k:'全身'}], 'オーナー');
// 定期便：初回は対象外・2ヶ月目以降は5%
...
const expect = [
  ['契約 1件目 5%（8/5 お客様A287,280）', 14364],
  ['契約 2件目 5%（8/8 お客様B198,000）', 9900],
  ['契約 3件目 8%（お客様C302,400）', 24192],
  ['契約 4件目 8%（お客様B151,620・端数切捨）', 12129],
  ['契約 5件目 10%（お客様D287,280）', 28728],
  ['契約 6件目 10%（お客様D302,400）', 30240],
